...
- Extensions are isolated from each other: never import local helper code across extensions. Reuse public package APIs, or keep a private copy of small helpers inside each extension.
