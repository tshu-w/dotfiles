# Generated by Powerlevel10k configuration wizard on 2020-06-10 at 11:34 CST.
...
# full frame, lightest-ornaments, sparse, concise, transient_prompt,
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=magenta # 76
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=red # 196
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=blue # 31
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=04 # 39
  ...
  typeset -g POWERLEVEL9K_ANACONDA_FOREGROUND=79 # 37
  ...
  typeset -g POWERLEVEL9K_ANACONDA_CONTENT_EXPANSION='${${${CONDA_PROMPT_MODIFIER#\(}#base}%\) }'
